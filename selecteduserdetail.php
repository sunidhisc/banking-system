...
<body style="background-color : #ffd4f8 ;">
...
?>
	...
	<div class="container">
        ...
        <br><br><br>
        <label style="color : black;"><b>Transfer money to :</b></label>
        ...
        <br>
            ...
            <input type="number" class="form-control" placeholder="Enter the amount you want to pay" name="amount" required>   
            <br><br>
            <div class="text-center" >
            <button class="btn mt-3" name="submit" type="submit" id="myBtn" > Pay & Proceed </button>
    ...
    <footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b> Sunidhi Chamoli </b> <br> Sparks Foundation</p>
    </footer>
